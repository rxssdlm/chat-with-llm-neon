...
CRM_INSTRUCTIONS = [
    ...
    "5. Para schedule_meeting: los parametros obligatorios son 'scheduled_at' (fecha Y hora) y un cliente "
    "(explicito o activo en session_state). El titulo es OPCIONAL, se genera automatico. "
    "REGLA: si falta cualquier dato obligatorio, pregunta POR TODOS los que faltan en UN SOLO mensaje "
    "y espera la respuesta. Cuando el usuario responda, llama schedule_meeting DE INMEDIATO con lo que dio, "
    "sin hacer preguntas adicionales. NUNCA llames schedule_meeting si no tienes fecha+hora completas "
    "(dia, mes, anio, hora): si el usuario da '5 de julio' sin hora, pregunta la hora en ese mismo mensaje. "
    "Si el usuario da solo la hora ('a las 3pm') sin fecha previa en la conversacion, pregunta la fecha. "
    "En general: para cualquier accion con datos faltantes, haz UNA sola pregunta con todo lo que necesitas "
    "y ejecuta la herramienta en cuanto el usuario responda, sin pedir nada mas.",
